...
export const CONCEPTS = [
  ...
  concept('joy', '기쁨', 'near', { warmth: .2, motion: .24, light: .15, tension: -.04 },
    '행복 행복한 행복하다 행복해 기쁨 기쁘 기쁜 기뻐 즐거 즐거운 즐겁다 신나 신나는 신난 재밌 재미있 재미난 웃 웃음 웃다 미소 미소짓 설렘 두근 반가 축하 환호 들뜬 유쾌 상쾌 희망 춤추 춤춘',
    'happy happily happiness joy joyful glad delight cheerful smile laugh laughter excited exciting celebrate hooray hope hopeful fun amusing enjoyable pleased thrilled'),
  concept('love', '사랑과 온기', 'near', { warmth: .31, softness: .19, light: .07, tension: -.05 },
    '사랑 사랑해 사랑스럽 좋아 좋은 좋아해 다정 애정 연인 친구 가족 엄마 아빠 아이 아기 품 포옹 안아 입맞춤 온기 따뜻 따뜻한 따뜻해 포근 친절 예쁘 예쁜 예뻐 예쁘다 아름다 아름다운 아름답 귀엽 귀여운 귀여워 소중',
    'love loved loving lovely lovable tender affection friend family mother father child baby hug embrace kiss warmth warm cozy kind kindness beautiful beauty pretty adorable cute precious dear'),
  ...
  concept('motion', '움직임', 'near', { motion: .32, space: .04 },
    '달리 뛰 날 날아 흐르 건너 건넌 걷 기어 오르 내리 헤엄 돌 회전 빠르 서두르 쫓 던지 흔들 움직 움직이 달리다 뛰다 걷다 여행 떠나 퍼지 번지 솟구치 미끄러 굴러',
    'run runs running runner jump jumping leap fly flying flow flowing cross crossing walk walking crawl climb fall falling descend swim spin rotate fast quickly hurry chase throw shake move moving movement travel leave spread scatter rise glide roll'),
  ...
  concept('thought', '생각', 'near', { space: .08, softness: .1, tension: .05 },
    '생각 생각해 생각난 떠올리 상상 궁금 궁금해 이해 알다 알아 깨닫 깨달음 믿 믿음 의심 고민 망설 결정 선택 이유 의미 질문 답 해답 기억 잊어 배우 배움 공부 지혜 마음속',
    'think thinking thought idea imagine imagine curious curiosity wonder understand know knowledge realize insight believe belief doubt worry ponder decide choice reason meaning question answer solution learn learning study wisdom mind'),
  concept('story', '이야기와 글', 'near', { space: .12, softness: .08, light: .04 },
    '이야기 글 글자 문장 단어 문학 시 시집 소설 책 책장 읽 읽다 쓰 쓰다 글씨 편지 일기 페이지 종이 연필 펜 그림 그리다 제목 구절',
    'story tale text letter sentence word poem poetry novel book read reading write writing handwriting journal page paper pencil pen draw drawing title phrase verse'),
  concept('home', '장소와 쉼터', 'far', { space: .2, softness: .11, warmth: .08 },
    '집 고향 방 거실 부엌 창문 마당 지붕 문턱 다락 쉼터 안식처 둥지 이불 침대 베개 의자 책상 교실 학교 놀이터',
    'home hometown house room livingroom kitchen window yard roof doorway attic shelter nest blanket bed pillow chair desk classroom school playground place'),
  concept('food', '음식', 'near', { warmth: .14, softness: .04, motion: .03 },
    '밥 음식 요리 먹 먹다 마시 마셔 빵 국수 라면 떡 김치 밥상 식탁 한입 물 맛있는 맛있 달콤 고소 바삭 따끈 배고프 포만',
    'food cook cooking eat eating drink meal dinner lunch breakfast rice noodle ramen soup bread cake cookie chocolate cheese soup delicious tasty yummy hungry feast bite chew sip'),
  concept('connection', '만남과 관계', 'near', { warmth: .18, softness: .12, tension: -.03 },
